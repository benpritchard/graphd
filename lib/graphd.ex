defmodule Graphd do
  ...
  ## Example of usage
      ...
      iex> {:ok, conn} = Graphd.start_link()
      {:ok, #PID<0.216.0>}
  """
  @spec start_link(keyword) :: {:ok, pid} | {:error, Graphd.Error.t() | term}
  def start_link(opts \\ []) do
    opts = default_opts(opts)
    DBConnection.start_link(Graphd.Protocol, opts)
  end
  ...
  defp json_library(), do: Application.get_env(:graphd, :json_library, Jason)
  ...
  def child_spec(opts) do
    opts = default_opts(opts)
    DBConnection.child_spec(Graphd.Protocol, opts)
  end
  ...
  Example
      ...
      iex> Graphd.alter(conn, "name: string @index(term) .")
      {:ok, ""}
  ...
  """
  @spec alter(conn, iodata | map, keyword) :: {:ok, map} | {:error, Graphd.Error.t() | term}
  ...
  Alter dgraph schema
  """
  @spec alter!(conn, iodata | map, keyword) :: map
  def alter!(conn, statement, opts \\ []) do
  ...
  @spec set(conn, query_map | map, statement, keyword) ::
          {:ok, map} | {:error, Graphd.Error.t() | term}

  def set(conn, query, statement, opts), do: mutate(conn, query, [%{set: statement}], opts)

  @doc """
  The same as `Graphd.set(conn, "", statement, [])`
  """
  @spec set(conn, statement) :: {:ok, map} | {:error, Graphd.Error.t() | term}
  def set(conn, statement), do: mutate(conn, %{}, [%{set: statement}], [])

  @doc """
  The same as `Graphd.set(conn, "", statement, opts)`.
  """
  @spec set(conn, query_map | statement, statement | keyword) ::
          {:ok, map} | {:error, Graphd.Error.t() | term}
  ...
  @doc """
  Runs a mutation and returns the result or raises `Graphd.Error` if there was an error.
  See `set/4`.
  """
  @spec set!(conn, query_map, statement, keyword) :: map | no_return
  ...
  See `set/3`.
  """
  @spec set!(conn, query_map | statement, statement | keyword) :: map | no_return
  ...
  Example of usage
      ...
      iex> mutation = "
           ...
           _:foo <owns> _:bar .
            _:bar <name> "Bar" .
           "
      iex> Graphd.mutate(conn, %{set: mutation})
      {:ok, %{uids: %{"bar" => "0xfe04c", "foo" => "0xfe04b"}, queries: %{}}}

  Using `json`

      iex> json = %{"name" => "Foo", "owns" => [%{"name" => "Bar"}]}
           Graphd.mutate(conn, %{set: json})
      {:ok, %{uids: %{"blank-0" => "0xfe04d", "blank-1" => "0xfe04e"}, queries: %{}}}
      iex> Graphd.mutate(conn, %{set: json}, return_json: true)
      {:ok,
       %{json: %{
         "name" => "Foo",
         "owns" => [%{"name" => "Bar", "uid" => "0xfe050"}],
  ...
  @spec mutate(conn, query_map | map, mutations, keyword) ::
          {:ok, map} | {:error, Graphd.Error.t() | term}
  ...
  @doc """
  The same as `Graphd.mutate(conn, "", mutations, [])`
  """
  @spec mutate(conn, mutations) :: {:ok, map} | {:error, Graphd.Error.t() | term}
  def mutate(conn, mutations), do: mutate(conn, %{}, mutations, [])

  @doc """
  The same as `Graphd.mutate(conn, "", mutations, opts)`.
  """
  @spec mutate(conn, query_map | mutations, mutations | keyword) ::
          {:ok, map} | {:error, Graphd.Error.t() | term}
  ...
  See `mutate/5`.
  """
  @spec mutate!(conn, query_map, mutations, keyword) :: map | no_return
  ...
  See `mutate/4`.
  """
  @spec mutate!(conn, mutations, keyword) :: map | no_return
  ...
  Example of usage
      ...
      iex> Graphd.delete(conn, %{"uid" => "0xfe04c"})
      {:ok, %{queries: %{}, uids: %{}}}

  Using `json`

      iex> json = %{"uid" => "0xfe04c"}
           Graphd.delete(conn, json)
      {:ok, %{queries: %{}, uids: %{}}}

      iex> Graphd.delete(conn, json, return_json: true)
  ...
  """
  @spec delete(conn, query_map | query, statement, keyword) ::
          {:ok, map} | {:error, Graphd.Error.t() | term}
  def delete(conn, query, statement, opts), do: mutate(conn, query, [%{delete: statement}], opts)

  @doc """
  The same as `Graphd.delete(conn, "", deletion, [])`
  """
  @spec delete(conn, statement) :: {:ok, map} | {:error, Graphd.Error.t() | term}
  def delete(conn, statement), do: mutate(conn, %{}, [%{delete: statement}], [])

  @doc """
  The same as `Graphd.delete(conn, query, deletion, [])` or `Graphd.delete(conn, "", deletion, opts)`
  """
  @spec delete(conn, query | statement, statement | keyword) ::
          {:ok, map} | {:error, Graphd.Error.t() | term}
  ...
  @doc """
  Runs a mutation with delete target and returns the result or raises `Graphd.Error` if there was
  an error. See `delete/4`.
  """
  @spec delete!(conn, query_map | query, statement, keyword) :: map | no_return
  ...
  """
  @spec delete!(conn, query | statement, statement | keyword) :: map | no_return
  ...
  Example of usage
      ...
      iex> query = "
           ...
           "
      iex> Graphd.query(conn, query, %{"$a" => "Foo"})
  ...
  Query options (see DGraph documentation for more information):
      ...
      * `read_only` - `boolean`
  """
  @spec query(conn, iodata, map, keyword) :: {:ok, map} | {:error, Graphd.Error.t() | term}
  ...
  @doc """
  Runs a query and returns the result or raises `Graphd.Error` if there was an error.
  See `query/3`.
  """
  @spec query!(conn, iodata, map, keyword) :: map | no_return
  def query!(conn, statement, parameters \\ %{}, opts \\ []) do
  ...
  """
  @spec query_schema(conn) :: {:ok, map} | {:error, Graphd.Error.t() | term}
  ...
  """
  @spec transaction(conn, (DBConnection.t() -> result :: any), keyword) ::
          {:ok, result :: any} | {:error, any}
  def transaction(conn, fun, opts \\ []) do
    try do
      DBConnection.transaction(conn, fun, opts)
    catch
      :error, %Graphd.Error{} = error ->
        {:error, error}
    end
  end
end
