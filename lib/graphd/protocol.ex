defmodule Graphd.Protocol do
  @moduledoc false

  alias Graphd.{Adapter, Error, Type, Query}
  alias Graphd.Api.TxnContext
  ...
  defp get_adapter(:grpc), do: Graphd.Adapters.GRPC
  defp get_adapter(:http), do: Graphd.Adapters.HTTP
